...
\providecommand{\btab}[1]{\begin{table}[htbp]\begin{center}\begin{tabular}{#1}}
...
\begin{figure} \begin{center} \makebox{\epsfysize=70mm \epsfbox{gal.eps}}   \end{center} \end{figure}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}
